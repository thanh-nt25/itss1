      ...
      <div className="flex">
        ...
        <div className="w-1/4 bg-white p-4 rounded shadow mr-4">
          ...
          <div className="grid grid-cols-5 gap-2">
            {Array.from({ length: practice.number_of_questions }, (_, index) => (
              <button
                key={index}
        ...
        <div className="w-3/4 bg-white p-4 rounded shadow">
          ...
          <div className="mb-4">
          {practice.questions[currentQuestion].type === "video" && (
            <>
            <div className="mb-4">
              <iframe
                width="100%"
                height="315"
                src={practice.questions[currentQuestion].video}
            ...
            {practice.questions[currentQuestion].type === "fill_in_the_blank" && (
              <input
                type="text"
                className="w-full p-2 border rounded"
                placeholder="回答を入力してください"
            ...
            {practice.questions[currentQuestion].type === "single_choice" && (
            ...
            {practice.questions[currentQuestion].type === "multiple_choice" && (
              <div className="flex flex-col">
                {practice.questions[currentQuestion].options.map((option, index) => (
                  <label key={index} className="flex items-center mb-2">
                    <input
